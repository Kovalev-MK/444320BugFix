  ...
  partial class ApprovalCheckingAssignmentActions
  {
    ...
    public virtual void AssignDocumentNumberavis(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      ...
      if (document != null)
      {
        ...
        {
          e.AddError(lenspec.Etalon.ApprovalCheckingAssignments.Resources.RegistrationNumberIsReserved);
        }
    ...
    public override void Accept(Sungero.Workflow.Client.ExecuteResultActionArgs e)
    {
      ...
      if (document != null)
      {
        ...
        var isReserved = Functions.ApprovalCheckingAssignment.Remote.CheckReservationDocument(_obj, document);
        ...
        var isBodyUpdated = Functions.ApprovalCheckingAssignment.Remote.UpdateDocumentBody(_obj);
        ...
        // Проверка статуса регистрации всех приложений при согласовании заявки на создание доверенности
        ...
        var checkVersionsErrorMessage = Functions.ApprovalCheckingAssignment.Remote.CheckDocumentVersions(_obj, document);
        ...
        var check1CFieldsErrorMessage = Functions.ApprovalCheckingAssignment.Remote.Check1CFields(_obj, document);
      ...
      {
        Functions.ApprovalCheckingAssignment.Remote.RefreshDocumentDeliveryMethod(_obj, _obj.DeliveryMethodavis);
      }
    }
