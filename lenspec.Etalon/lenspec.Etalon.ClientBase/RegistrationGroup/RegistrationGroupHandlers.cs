...
namespace lenspec.Etalon
{
  partial class RegistrationGroupClientHandlers
  {
    ...
    public override void Refresh(Sungero.Presentation.FormRefreshEventArgs e)
    {
      ...
      var isResponsible = _obj.AccessRights.CanUpdate() && Sungero.Docflow.Client.ModuleFunctions.CalculateParams(e, _obj, true, false, false, false, null);
      ...
      if (_obj.AccessRights.CanUpdate() && Sungero.Docflow.Client.ModuleFunctions.CalculateParams(e, _obj, false, true, false, false, null))
      {
