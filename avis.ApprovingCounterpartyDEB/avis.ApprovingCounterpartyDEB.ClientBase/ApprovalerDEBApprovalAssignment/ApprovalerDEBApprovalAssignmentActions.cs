...
{
  partial class ApprovalerDEBApprovalAssignmentActions
  {
    public virtual void NewPerformer(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      ...
      if (string.IsNullOrWhiteSpace(_obj.ActiveText))
        _obj.ActiveText = "Переадресовано";
      _obj.Result = ApprovingCounterpartyDEB.ApprovalerDEBApprovalAssignment.Result.Forward;
      _obj.Abort();
      e.CloseFormAfterAction = true;
    }

    public virtual bool CanNewPerformer(Sungero.Domain.Client.CanExecuteActionArgs e)
    {
      return _obj.Status == ApprovalerDEBApprovalAssignment.Status.InProcess;
    }
