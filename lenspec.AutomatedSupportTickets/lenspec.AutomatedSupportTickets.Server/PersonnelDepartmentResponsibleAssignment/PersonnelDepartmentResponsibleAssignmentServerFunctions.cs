...
{
  partial class PersonnelDepartmentResponsibleAssignmentFunctions
  {
    ...
    /// </summary>       
    [Remote]
    public StateView GetPersonnelDepartmentResponsibleAssignmentState2()
    {
      ...
      if (_obj.BlockUid == "13")
      {
        instruction = "Ваша учетная запись скоро будет отключена. Пожалуйста, завершите свои невыполненные входящие задания и исходящие задачи.";
    ...
    /// </summary>       
    [Remote]
    public StateView GetPersonnelDepartmentResponsibleAssignmentState()
    {
