...
{
  partial class SDAActAcceptanceOfApartmentFunctions
  {
    /// <summary>
    ...
    public override void FillName()
    {
      ...
      using (TenantInfo.Culture.SwitchTo())
      {
        ...
        if (_obj.ClientNew.Any(x => x.Client != null))
          name += lenspec.SalesDepartmentArchive.SDAActBases.Resources.NamePartClient + 
            string.Join(", ", _obj.ClientNew.Where(x => x.Client != null).Select(x => x.Client.Name).ToList());
      }
