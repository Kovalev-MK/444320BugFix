  ...
  partial class ActsOfManagementCompanyBaseFunctions
  {
    ...
    public override void FillName()
    {
      ...
      using (TenantInfo.Culture.SwitchTo())
      {
        ...
        if (_obj.ManagementContractMKD != null)
          name += Sungero.Docflow.OfficialDocuments.Resources.NamePartForLeadDocument + _obj.ManagementContractMKD.Name;
        
        if (_obj.Owner != null)
          name += lenspec.SalesDepartmentArchive.SDAActBases.Resources.NamePartClient + _obj.Owner.Name;
      }
